...
\definecolor{headliner}{rgb}{0.0,0.20,0.40}
\usepackage{resume}
...
\begin{center}
    {
    %\small AE-312, MS Hall of Residence, IIT Kharagpur, West Bengal, India - 721 302 | 
...
\vspace{-0.1ex}
\roottitle{\Large{\color{headliner} TEACHING EXPERIENCE}}
{\color{headliner} \spacedhrule{0.15ex}{1.0ex}}
...
\vspace{-0.1ex}
\roottitle{\Large{\color{headliner} MAJOR PROJECTS}}
{\color{headliner} \spacedhrule{0.15ex}{1.0ex}}
...
\begin{itemize}
    ...
    %\item Developed Communication Protocol between Server and Client to support commands like get() and put().\\[-1.9em]
...
\vspace{-2.2ex}
\roottitle{\Large{\color{headliner} AWARDS and ACHIEVEMENTS}}
{\color{headliner} \spacedhrule{0.15ex}{1.0ex}}
...
\roottitle{\Large{\color{headliner} TERM PROJECTS}}
{\color{headliner} \spacedhrule{0.15ex}{1.0ex}}
...
\begin{itemize}
    ...
    % \item Implemented a \textbf{multi-threaded} Sparse-Matrix Multiplication program and analysed change in execution time with number of threads, chunks size assigned to each thread and scheduling algorithms.\\[-0.5em]
\end{itemize}
\vspace{-0.5ex}    
...
\vspace{-2ex}
\roottitle{\Large{\color{headliner} OTHER PROJECTS}}
{\color{headliner} \spacedhrule{0.15ex}{1.0ex}}
\begin{indentsection}
...
\iffalse
\vspace{-0.6ex}
\roottitle{\Large{\color{headliner} COURSEWORK INFORMATION} }%\hspace{0.1ex} \large \href{https://github.com/shmundhra/Credentials/blob/master/Academics/AcademicTranscript_IITKGP.pdf}{\faMousePointer}}
{\color{headliner} \spacedhrule{0.15ex}{1.0ex}}
\begin{indentsection}
...
\vspace{-0.5ex}
\roottitle{\Large{\color{headliner} SKILLS and EXPERTISE}}
{\color{headliner} \spacedhrule{0.15ex}{1.0ex}}
\begingroup
